...
<h1>Вітаю на тестовому сайті</h1>
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 640px; height: 360px; overflow: hidden; visibility: hidden;">
        <!-- Loading Screen -->
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 640px; height: 360px; overflow: hidden;">
